...
sudo mkdir /sys/kernel/config/nvmet/subsystems/nvmet-test4
cd /sys/kernel/config/nvmet/subsystems/nvmet-test4
echo 1 |sudo tee -a attr_allow_any_host > /dev/null
...
echo 172.31.7.53 |sudo tee -a addr_traddr > /dev/null
